...
@Component({
  selector: 'ngx-supporter-table',
  templateUrl: './supporter-table.component.html',
  styleUrls: ['./supporter-table.component.scss'],
})
export class SupporterTableComponent implements OnInit {
  ...
  constructor(private title: Title,
    private dataService: SupporterService, private toastrService: NbToastrService) {
  }

  ngOnInit(): void {
    this.title.setTitle('پنل مدیریت' + ' | ' + 'لیست ' + 'پشتبان ها');
